function fcn_hcp_meg_process_emptyroom(hcp_dir, subjList, badChannels, reports_dir)
% hcp_meg_process: Script to process empty-room MEG data from Human
% Connectime Project
%
...
%
% Outputs:
%     saves vertex-level source solutions for each
...
for iSubj = 1:length(SubjectNames)
    ...
    bst_process('CallProcess', 'process_headmodel', sFilesNoiseFull, [], ...
        'sourcespace', 1, ...  % Cortex surface
        'meg',         3);     % Overlapping spheres

    % Process: Compute sources [2018]
    sSrcNoise = bst_process('CallProcess', 'process_inverse_2018', sFilesNoiseFull, [], ...
    ...
    % Save Vertex x Time
    tsMatrix = file_fullpath(sSrcNoise.FileName);
